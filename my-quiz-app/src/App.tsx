...
function App() {
  ...
  return (
    <>
     <h1>ΘΕΜΑ A</h1>
    <p>A1. Να γράψετε στο τετράδιο σας τον αριθμό καθεμίας από τις παρακάτω προτάσεις 1 έως 5 και δίπλα τη λέξη ΣΩΣΤΟ, αν η πρόταση είναι σωστή ή τη λέξη ΛΑΘΟΣ, αν η πρόταση είναι λανθασμένη.</p>
    <ul>
      <li>Οποιαδήποτε εντολή επανάληψης ΟΣΟ...ΕΠΑΝΑΛΑΒΕ μπορεί να μετατραπεί σε εντολή επανάληψης ΓΙΑ...ΑΠΟ...ΜΕΧΡΙ...ΜΕ_ΒΗΜΑ.</li>
      <li>Η μέθοδος επεξεργασίας «πρώτο μέσα πρώτο έξω» (FIFO) εφαρμόζεται στη δομή δεδομένων ΟΥΡΑ.</li>
      </ul>
